...
A complete log of my data science and web development skills, learning, resources, and interests. It's a way to keep track of and organize my learning pathway. This learning tracker is adapted from [Syk Houdeib's Web Development Learning Tracker](https://github.com/Syknapse/My-Learning-Tracker/blob/master/log.md).
